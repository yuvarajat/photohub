        ...
        imageframer: function(options) {
            ...
            if ( o.disable !== true ) {
                ...
                var sifWrap = obj.parent('.if-wrap'),
                    background = [ ' background-image: url( images/editor/imageframer/frames/'+ frameType + '-' + frameSize + '/', '.png ); ' ];
                ...
                if ( o.innerShadow ) {
                    ...
                    $('<img class="if-innerShadow" src="/images/editor/imageframer/innerShadows/is-'+ is +'.png" alt="" />').appendTo( sifWrap );
                }
